      ...
      <Table striped bordered hover responsive>
        ...
        <tbody>
          {Sessions.map((session) => {
              return (
                <tr>
                  <td id='sessionName' class="text-primary" onClick={()=>handleTableCellClick(session.SessionId)}>{session.SessionName}</td>
                 
                  <td ref={target} onClick={() => setShow(!show)}>{session.SessionId}</td>
          ...
          <div className = {s.searchBarContainer}>
              <Form onSubmit={handleSearchSessions}> 
                  ...
                  <Form.Group as={Col} >
                    ...
                    <Col sm="12">
                        <Form.Control required as="select" label=" " value={patientId} onChange={e => {console.log('p', e.target.value); setPatientId(e.target.value)}} onClick={listPatients}>
                          <option value={''}></option>
                  ...
                  <Form.Group required as={Col}>
                    ...
                    <Col sm="12">
                        <Form.Control required as="select" label=" " value={healthCareProfessionalId} onChange={e => {console.log(e.target.value); setHealthCareProfessionalId(e.target.value); console.log(healthCareProfessionalName)}} onClick={listHealthCareProfessionals}>
                          <option value={''}></option>
                  ...
                  <Form.Group as={Col} id="formSessionId">
                    ...
                    <Col sm="12">
                      <Form.Control required type="text" placeholder="Session Id" name="sessionId" value={sessionId} onChange={e => setSessionId(e.target.value)}/>
